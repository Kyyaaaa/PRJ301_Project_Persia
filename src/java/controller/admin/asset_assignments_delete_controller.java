    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (assignmentIdStr != null && !assignmentIdStr.isEmpty()) {
            try {
                ...
                request.getRequestDispatcher("/WEB-INF/admin/asset-assignments_delete.jsp").forward(request, response);
                return;
        ...
        response.sendRedirect(request.getContextPath() + "/admin/asset-assignments");
    }
