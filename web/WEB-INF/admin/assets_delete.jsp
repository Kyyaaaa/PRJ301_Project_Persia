    ...
    <body>
        ...
        <div class="container">
            <div class="card delete-card text-center p-5">
                ...
                <h3 class="mb-3 fw-bold">Delete Asset?</h3>
                <p class="text-muted mb-4">Are you sure you want to delete this asset? It will be permanently removed.</p>
                <form action="<%= request.getContextPath() %>/admin/assets/delete" method="post">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <a href="<%= request.getContextPath() %>/admin/assets" class="btn btn-light px-4 border">Cancel</a>
