    ...
    <body>
        ...
        <div class="container">
            <div class="card delete-card text-center p-5">
                ...
                <p class="text-muted mb-4">Are you sure you want to discard this request? All related traces will be removed.</p>
                <form action="<%= request.getContextPath() %>/admin/requests/delete" method="post">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <a href="<%= request.getContextPath() %>/admin/requests" class="btn btn-light px-4 border">Cancel</a>
